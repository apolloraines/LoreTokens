...
- EXPAND.MED.NEURO:SCI:S13_C4_SUB10:[brain+nervous+diagnosis>>med_specialty,ACTIVE]
  ⟵ ⟵ example Meaning Capsule that can expand into hundreds of pages of medical documentation.
...
### Just some Funny
Some poor OpenAI engineer: “Why does ChatGPT keep using em dashes?”

Apollo - “Because you never told the AI: PUNCTUATION.EMDASH:[usage_limit=0>>style_rules,ENFORCED]”
- If they had: A LoreToken for style rules - Stored in a SAIQL DB - Loaded at runtime as Cognitive DNA - they could have just flipped the “no em dash” flag and hot-swapped the behavior without retraining or prompt duct tape.
